...
- **� 用户权限管理**：灵活的基于角色的访问控制（超级管理员、租户管理员、普通用户），支持用户级别和租户级别的菜单权限配置
...
**核心文档：**
- [权限管理系统](./docs/权限管理系统.md) - 用户角色和权限配置指南
- [知识图谱配置](./docs/开启知识图谱功能.md) - 知识图谱功能配置说明
- [MCP功能使用](./docs/MCP功能使用说明.md) - MCP工具集成指南
