...
:: aiplusall-kb Full Project Reset Script for Windows
:: This script will clean all debugging data, Docker images, and reset the project to initial state

echo.
echo ========================================
echo aiplusall-kb Full Project Reset
echo ========================================
echo.
echo This will delete ALL data AND Docker images, then reset the project to initial state.
echo.
...
for %%i in (wechatopenai/aiplusall-kb-app:latest wechatopenai/aiplusall-kb-docreader:latest wechatopenai/aiplusall-kb-ui:latest) do (
    docker images -q %%i >nul 2>&1
    if not errorlevel 1 (
